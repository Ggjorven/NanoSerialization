...
1. Clone the repository:
    ```sh
    git clone --recursive https://github.com/ggjorven/NanoSerialization.git
    cd NanoSerialization
    ```
...
- Visual Studio 17 2022:
    ...
    2. Open the NanoSerialization.sln file
...
### MacOS
1. Navigate to the root of the directory
2. Open the NanoSerialization.xcworkspace file
3. Start building in your desired configuration
